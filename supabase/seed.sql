...
CREATE TABLE IF NOT EXISTS "public"."pal_token_balances" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "wallet_address" "text" NOT NULL,
    "last_fetched_balance" "text" DEFAULT '''0'''::"text" NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "public"."pal_tokens" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "view_token_required" "text" DEFAULT '1000000000000000000'::"text" NOT NULL,
    "write_token_required" "text" DEFAULT '1000000000000000000'::"text" NOT NULL,
    "last_fetched_price" "text" DEFAULT '''0'''::"text" NOT NULL
);
