CREATE OR REPLACE FUNCTION "public"."get_held_or_owned_tokens"(
...
ALTER FUNCTION "public"."get_held_or_owned_tokens"(text, timestamp with time zone, integer) OWNER TO "postgres";

GRANT ALL ON FUNCTION "public"."get_held_or_owned_tokens"(text, timestamp with time zone, integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_held_or_owned_tokens"(text, timestamp with time zone, integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_held_or_owned_tokens"(text, timestamp with time zone, integer) TO "service_role";
